...
export const REGISTRY: DbTableDef[] = [
  {
    ...
    searchColumns: ["kundennummer", "firmenname", "nachname", "vorname", "email", "ort"],
    ...
    editable: [
      ...
      { column: "hausnummer", label: "Hausnr.", type: "text" },
  ...
  },
  {
    ...
    icon: "Building2",
    listColumns: [
      { column: "objektnummer", label: "Nr." },
      { column: "bezeichnung", label: "Bezeichnung" },
      { column: "kunde_id", label: "Kunde" },
      { column: "ort", label: "Ort" },
      { column: "erstellt_am", label: "Erstellt", type: "datetime" },
    ],
    searchColumns: ["objektnummer", "bezeichnung", "ort", "strasse"],
    dateColumn: "erstellt_am",
    kundeColumn: "kunde_id",
    editable: [
      { column: "bezeichnung", label: "Bezeichnung", type: "text" },
      { column: "strasse", label: "Straße", type: "text" },
      { column: "hausnummer", label: "Hausnr.", type: "text" },
      { column: "plz", label: "PLZ", type: "text" },
      { column: "ort", label: "Ort", type: "text" },
  ...
  },
  {
    ...
    searchColumns: ["titel", "inhalt"],
    dateColumn: "erstellt_am",
    kundeColumn: "kunde_id",
    editable: [
      { column: "titel", label: "Titel", type: "text" },
      { column: "inhalt", label: "Inhalt", type: "longtext" },
    ],
    hasGeloeschtAm: true,
  },
  {
  ...
  },
  {
    ...
    listColumns: [
      { column: "bezeichnung", label: "Bezeichnung" },
      { column: "betrag_ct", label: "Betrag (Cent)", type: "number" },
      { column: "faelligkeit", label: "Fälligkeit", type: "date" },
      { column: "erstellt_am", label: "Erstellt", type: "datetime" },
    ],
    searchColumns: ["bezeichnung"],
    dateColumn: "faelligkeit",
    editable: [
      { column: "bezeichnung", label: "Bezeichnung", type: "text" },
      { column: "betrag_ct", label: "Betrag (Cent)", type: "number" },
      { column: "faelligkeit", label: "Fälligkeit", type: "date" },
      { column: "bemerkung", label: "Bemerkung", type: "longtext" },
    ],
    hasGeloeschtAm: true,
  },
];
